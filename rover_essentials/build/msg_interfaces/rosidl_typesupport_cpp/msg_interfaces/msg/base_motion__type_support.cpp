...
static const _BaseMotion_type_support_symbol_names_t _BaseMotion_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msg_interfaces, msg, BaseMotion)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msg_interfaces, msg, BaseMotion)),
  }
};
...
{
  return &::msg_interfaces::msg::rosidl_typesupport_cpp::BaseMotion_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, msg_interfaces, msg, BaseMotion)() {
  return get_message_type_support_handle<msg_interfaces::msg::BaseMotion>();
}
