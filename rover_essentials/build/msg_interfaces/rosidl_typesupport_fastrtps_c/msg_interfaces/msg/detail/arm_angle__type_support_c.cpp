...
#include "msg_interfaces/msg/detail/arm_angle__rosidl_typesupport_fastrtps_c.h"
...
using _ArmAngle__ros_msg_type = msg_interfaces__msg__ArmAngle;
  ...
  void * untyped_ros_message)
{
  ...
  _ArmAngle__ros_msg_type * ros_message = static_cast<_ArmAngle__ros_msg_type *>(untyped_ros_message);
  // Field name: alpha
  {
    cdr >> ros_message->alpha;
  }
...
size_t get_serialized_size_msg_interfaces__msg__ArmAngle(
  const void * untyped_ros_message,
...
static uint32_t _ArmAngle__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_msg_interfaces__msg__ArmAngle(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_msg_interfaces
size_t max_serialized_size_msg_interfaces__msg__ArmAngle(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = msg_interfaces__msg__ArmAngle;
    is_plain =
      (
...
static size_t _ArmAngle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_msg_interfaces__msg__ArmAngle(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msg_interfaces, msg, ArmAngle)() {
